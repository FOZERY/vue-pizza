...
<template>
    <div class="group flex pb-3 cursor-pointer border-b last:border-0 sm:border-0">
        <div class="flex gap-2 sm:flex-col">
            <img
                class="group-hover:-translate-y-1 transition duration-300 w-32 h-32 sm:w-60 sm:h-60 mx-auto"
                :src="imageUrl"
                :alt="name"
            />
