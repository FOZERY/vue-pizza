            ...
            <div class="flex flex-col flex-1">
                <nav class="flex flex-col mt-5 px-7 gap-1.5">
                    <router-link :to="{name: 'admin-products'}" class="flex items-center ">
                        ...
                        <span class="ml-3 text-white text-lg hover:text-stone-400 transition duration-300">Продукты</span>
                    </router-link>
                    <router-link to="/admin/customers" class="flex items-center hover:text-stone-400 ">
                        <img class="h-5" src="/admin-icons/user.svg" />
                        <span class="ml-3 text-white text-lg hover:text-stone-400 transition duration-300">Клиенты</span>
                    </router-link>
                    <router-link to="/admin/couriers" class="flex items-center hover:text-stone-400">
                        <img class="h-5" src="/admin-icons/delivery.svg" />
                        <span class="ml-3 text-white text-lg hover:text-stone-400 transition duration-300">Курьеры</span>
                    </router-link>
                ...
                <router-link class="mt-auto mx-5 flex justify-center items-center" :to="{name: 'main'}">
